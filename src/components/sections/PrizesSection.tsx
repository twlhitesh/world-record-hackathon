...
const PrizesSection = () => {
  ...
  const DesktopPrizeCard = ({ prize, index }: { prize: typeof prizes[0], index: number }) => (
    ...
    >
      <div className="overflow-hidden h-[400px] relative cursor-pointer transition-all duration-500 hover:scale-[1.02] rounded-lg border border-neutral-800 hover:border-neutral-700 bg-black">
        <div className="absolute inset-0 bg-cover bg-center transition-all duration-500 group-hover/card:scale-105" style={{ backgroundImage: `url(${prize.image})` }}>
